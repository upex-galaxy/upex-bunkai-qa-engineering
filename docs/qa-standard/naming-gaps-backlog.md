...
| 8 | Test-execution folders | `test-executions/{EXEC-KEY}-{ts}/` → `PROJ-555-20260626T1430Z/` | AGENTS.md §9 PBI tree · `scripts/sync-jira-issues.ts` |
| 9 | Nested defect files | mirror the Story layout: `bug.md` + `evidence/` + `related-tests/` | AGENTS.md §9 · `scripts/sync-jira-issues.ts` |
